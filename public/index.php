...
if ($routingMode === 'superadmin') {
    ...
    $routes = [
        ...
        'POST' => [
            ...
            '/tenants/extend-trial' => 'tenants/extend-trial',
            '/tenants/set-status' => 'tenants/set-status',
            '/users/store' => 'users/store',
            '/users/update' => 'users/update',
            '/users/reset-password' => 'users/reset-password',
            '/users/set-status' => 'users/set-status',
            '/users/delete' => 'users/delete',
            '/billing/cancel-subscription' => 'billing/cancel-subscription',
            '/billing/extend-trial' => 'billing/extend-trial',
            '/billing/set-status' => 'billing/set-status',
            '/billing/mark-invoice-paid' => 'billing/mark-invoice-paid',
