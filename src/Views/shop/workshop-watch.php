...
<section class="py-16 max-w-3xl mx-auto px-4">
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 text-center">
        ...
        <div class="aspect-video bg-gray-900 rounded-xl mb-8 flex items-center justify-center text-white text-sm p-6 text-center">
            You are unlocked. Continue into the full program or open the video courses library.
        </div>
        <div class="flex flex-wrap gap-3 justify-center">
            ...
            <a href="/courses" class="inline-flex px-6 py-3 rounded-lg border border-gray-300 text-gray-800 font-semibold hover:bg-gray-50 transition">All courses (incl. video)</a>
        </div>
    </div>
</section>
<?php
