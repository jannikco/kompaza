        ...
        $categories = [
            [
                ...
                'questions' => [
                    ...
                    [
                        'q' => 'How do I sign up?',
                        'a' => 'Click "Get Started Free" on any page to create your account. You\'ll choose a subdomain (e.g., yourcompany.kompaza.com), fill in your details, and you\'re ready to go. No credit card is required for the free trial.',
                    ],
                    [
                        'q' => 'Is there a free trial?',
                        'a' => 'Yes! Every plan includes a 7-day free trial. No credit card is required to start. Feature access depends on the plan you select; you can upgrade anytime during or after your trial.',
                    ],
                    [
