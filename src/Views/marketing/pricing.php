...
<section class="relative overflow-hidden hero-gradient py-20">
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-blue-100/90 text-lg max-w-2xl mx-auto">
            Start free for 7 days — no credit card required. Upgrade, downgrade, or cancel anytime.
        </p>
    </div>
                    ...
                    <div class="relative bg-white rounded-2xl border <?= $isPopular ? 'border-indigo-300 shadow-xl shadow-indigo-100/50 ring-2 ring-indigo-500' : 'border-gray-200 shadow-sm' ?> overflow-hidden">
                        ...
                        <div class="p-8">
                            ...
                            <?php
                                $planFeatures = [
                                    'starter' => [
                                        ['label' => '5 products · 100 contacts', 'included' => true],
                                        ['label' => 'Branded site on your subdomain', 'included' => true],
                                        ['label' => 'Funnels & landing pages', 'included' => true],
                                        ['label' => 'Blog, e-books & lead magnets', 'included' => true],
                                        ['label' => 'Email marketing', 'included' => true],
                                        ['label' => 'Checkout, order bumps & upsells', 'included' => true],
                                        ['label' => 'Online courses & memberships', 'included' => false],
                                        ['label' => 'Community & webinars', 'included' => false],
                                        ['label' => 'A/B testing & analytics', 'included' => false],
                                        ['label' => 'LinkedIn automation', 'included' => false],
                                    ],
                                    'growth' => [
                                        ['label' => '100 products · 500 contacts', 'included' => true],
                                        ['label' => 'Everything in Starter', 'included' => true],
                                        ['label' => 'Online courses (full LMS)', 'included' => true],
                                        ['label' => 'Memberships & gated content', 'included' => true],
                                        ['label' => 'Community & discussions', 'included' => true],
                                        ['label' => 'Webinars & live Q&A', 'included' => true],
                                        ['label' => 'A/B testing & analytics', 'included' => true],
                                        ['label' => 'LinkedIn automation (ConnectPilot)', 'included' => true],
                                        ['label' => 'Payment processing', 'included' => true],
                                    ],
                                    'enterprise' => [
                                        ['label' => 'Unlimited products & contacts', 'included' => true],
                                        ['label' => 'Everything in Growth', 'included' => true],
                                        ['label' => 'Custom domain', 'included' => true],
                                        ['label' => 'Advanced funnels & upsells', 'included' => true],
                                        ['label' => 'Priority support', 'included' => true],
                                        ['label' => 'Onboarding assistance', 'included' => true],
                                    ],
                                ];
