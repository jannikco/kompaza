    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div>
            ...
            <select name="membership_tier_level" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                <option value="" <?= ($ebook['membership_tier_level'] ?? '') === '' || $ebook['membership_tier_level'] === null ? 'selected' : '' ?>>Not part of membership</option>
                <option value="0" <?= (isset($ebook['membership_tier_level']) && (int)$ebook['membership_tier_level'] === 0 && $ebook['membership_tier_level'] !== null) ? 'selected' : '' ?>>Free (Tier 0)</option>
                <option value="1" <?= (isset($ebook['membership_tier_level']) && (int)$ebook['membership_tier_level'] === 1) ? 'selected' : '' ?>>Pro (Tier 1)</option>
                <option value="2" <?= (isset($ebook['membership_tier_level']) && (int)$ebook['membership_tier_level'] === 2) ? 'selected' : '' ?>>Premium (Tier 2)</option>
            </select>
