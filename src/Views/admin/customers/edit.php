...
<div class="mb-6">
    <a href="/admin/kunder/<?= $customer['id'] ?>" class="text-sm text-gray-500 hover:text-gray-900 transition">&larr; Back to Customer</a>
    <h2 class="text-2xl font-bold text-gray-900 mt-1">Edit Customer</h2>
    <p class="text-sm text-gray-500 mt-1">Update customer information for <?= h($customer['name']) ?>.</p>
</div>
...
<form method="POST" action="/admin/kunder/opdater" class="max-w-4xl">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            <a href="/admin/kunder/<?= $customer['id'] ?>" class="px-4 py-2 text-sm text-gray-600 hover:text-white transition">Cancel</a>
