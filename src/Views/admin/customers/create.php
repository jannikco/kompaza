...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-white mt-1">Add Customer</h2>
    <p class="text-sm text-gray-400 mt-1">Create a new customer account.</p>
</div>
...
<form method="POST" action="/admin/kunder/gem" class="max-w-4xl">
    ...
    <div class="flex items-center justify-end space-x-3">
        <a href="/admin/kunder" class="px-4 py-2 text-sm text-gray-300 hover:text-white transition">Cancel</a>
