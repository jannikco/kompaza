...
<form method="POST" action="/admin/indstillinger/opdater" enctype="multipart/form-data" class="space-y-8">
    ...
    <!-- Homepage Design -->
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6" x-data="{ selectedTemplate: '<?= h($tenant['homepage_template'] ?? 'starter') ?>' }">
        ...
        <!-- Template Picker -->
        <div class="mb-6">
            <label class="block text-sm font-medium text-gray-700 mb-3">Homepage Template</label>
