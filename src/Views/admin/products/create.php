...
<form method="POST" action="/admin/produkter/gem" enctype="multipart/form-data" class="max-w-4xl" x-data="{ trackStock: false, isDigital: false, paymentPlan: false }">
    <?= csrfField() ?>
        ...
        <div class="space-y-4">
            ...
            <div x-show="paymentPlan" x-cloak class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="installment_count" min="2" max="24" value="3"
                ...
                <div>
                    ...
                    <input type="number" name="installment_price_dkk" step="0.01" min="0"
                ...
                <div>
                    ...
                    <input type="number" name="trial_days" min="0" max="90" value="0"
