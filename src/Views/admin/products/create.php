...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-white mt-1">Add Product</h2>
...
<form method="POST" action="/admin/produkter/gem" enctype="multipart/form-data" class="max-w-4xl" x-data="{ trackStock: false, isDigital: false }">
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-6 mb-6">
        ...
        <div>
            <label for="image" class="block text-sm font-medium text-gray-300 mb-1.5">Product Image</label>
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-6 mb-6">
        ...
        <div class="space-y-4">
            ...
            <div x-show="isDigital" x-cloak>
                <label for="digital_file" class="block text-sm font-medium text-gray-300 mb-1.5">Digital File</label>
