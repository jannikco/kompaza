...
<div class="mb-6">
    <a href="/admin/custom-pages" class="inline-flex items-center text-sm text-gray-400 hover:text-white transition">
...
<form method="POST" action="<?= $isEdit ? '/admin/custom-pages/update' : '/admin/custom-pages/store' ?>" class="space-y-8">
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-6">
        <h3 class="text-lg font-semibold text-white mb-6">Page Details</h3>
    ...
    <!-- Content -->
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-6">
        <h3 class="text-lg font-semibold text-white mb-2">Page Content (HTML)</h3>
        <p class="text-sm text-gray-400 mb-4">Raw HTML content. For "Full Page" layout, include complete HTML with styles and scripts. For "Shop Layout", content is wrapped in the site header/footer.</p>
        <textarea name="content" id="content" rows="40"
            class="w-full px-4 py-3 bg-gray-900 border border-gray-600 text-green-400 placeholder-gray-500 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent font-mono text-sm"
            placeholder="<!DOCTYPE html>..."><?= h($page['content'] ?? '') ?></textarea>
    </div>

    <!-- Settings -->
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-6">
        <h3 class="text-lg font-semibold text-white mb-6">Settings</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                <label for="layout" class="block text-sm font-medium text-gray-300 mb-2">Layout</label>
            ...
            <div class="md:col-span-3">
                <label class="flex items-center space-x-3">
                    ...
                    <span class="text-sm font-medium text-gray-300">Set as Homepage</span>
    ...
    <div class="flex items-center justify-end space-x-4">
        <a href="/admin/custom-pages" class="px-4 py-2 text-sm font-medium text-gray-300 bg-gray-700 hover:bg-gray-600 rounded-lg transition">
            Cancel
        </a>
