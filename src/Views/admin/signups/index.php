...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="/admin/tilmeldinger/eksporter" class="inline-flex items-center px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white text-sm font-medium rounded-lg transition border border-gray-600">
