    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <div class="flex items-center space-x-4 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Modtag betalinger for dine e-bøger</p>
            </div>
        </div>
        ...
        <div class="space-y-3 mb-6">
            <div class="flex items-center justify-between py-2 border-b border-gray-200">
                <span class="text-gray-500">Stripe-konto</span>
            ...
            <div class="flex items-center justify-between py-2 border-b border-gray-200">
                <span class="text-gray-500">Kan modtage betalinger</span>
                <span class="flex items-center <?= $chargesEnabled ? 'text-green-600' : 'text-red-600' ?>">
                    <?= $chargesEnabled ? 'Ja' : 'Nej' ?>
                </span>
            </div>
            <div class="flex items-center justify-between py-2">
                <span class="text-gray-500">Kan modtage udbetalinger</span>
