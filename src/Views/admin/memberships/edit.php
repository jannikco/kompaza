<?php
$pageTitle = 'Edit Plan: ' . h($plan['name']);
...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-900 mt-1">Edit Membership Plan</h2>
    <p class="text-sm text-gray-500 mt-1">Update settings for <?= h($plan['name']) ?>.</p>
</div>

<form method="POST" action="/admin/memberships/update" class="max-w-4xl">
    <?= csrfField() ?>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                ...
                <input type="text" id="name" name="name" required value="<?= h($plan['name']) ?>"
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" id="slug" name="slug" required value="<?= h($plan['slug']) ?>"
                       class="w-full px-4 py-2.5 bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
            ...
            <div>
                ...
                <input type="number" id="tier_level" name="tier_level" required min="0" value="<?= h($plan['tier_level']) ?>"
                       class="w-full px-4 py-2.5 bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                       placeholder="0">
            ...
            <div>
                ...
                <input type="number" id="sort_order" name="sort_order" min="0" value="<?= h($plan['sort_order'] ?? 0) ?>"
                       class="w-full px-4 py-2.5 bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                       placeholder="0">
            ...
            <div class="md:col-span-2">
                ...
                <textarea id="description" name="description" rows="3"
                          ...
                          placeholder="Describe what this membership plan includes..."><?= h($plan['description'] ?? '') ?></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div class="relative">
                    <input type="number" id="price_monthly" name="price_monthly" required step="0.01" min="0" value="<?= h($plan['price_monthly']) ?>"
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" id="price_yearly" name="price_yearly" step="0.01" min="0" value="<?= h($plan['price_yearly'] ?? '') ?>"
                           class="w-full pl-4 pr-16 py-2.5 bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                           placeholder="0.00">
                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                        <span class="text-gray-500 text-sm">DKK</span>
            ...
            <div>
                ...
                <input type="text" id="stripe_monthly_price_id" name="stripe_monthly_price_id" value="<?= h($plan['stripe_monthly_price_id'] ?? '') ?>"
                       class="w-full px-4 py-2.5 bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                       placeholder="price_...">
            ...
            <div>
                ...
                <input type="text" id="stripe_yearly_price_id" name="stripe_yearly_price_id" value="<?= h($plan['stripe_yearly_price_id'] ?? '') ?>"
                       class="w-full px-4 py-2.5 bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                       placeholder="price_...">
                <p class="text-xs text-gray-500 mt-1">From your Stripe dashboard.</p>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" id="discount_percent" name="discount_percent" step="1" min="0" max="100" value="<?= h($plan['discount_percent'] ?? '') ?>"
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="number" id="max_courses" name="max_courses" min="0" value="<?= h($plan['max_courses'] ?? '') ?>"
                       class="w-full px-4 py-2.5 bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
            ...
            <div>
                ...
                <input type="number" id="max_ebooks" name="max_ebooks" min="0" value="<?= h($plan['max_ebooks'] ?? '') ?>"
                       class="w-full px-4 py-2.5 bg-white border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                       placeholder="Leave empty for unlimited">
        ...
        <div class="space-y-4">
            <div class="flex items-center">
                <input type="checkbox" id="can_access_prompts" name="can_access_prompts" value="1"
                       <?= !empty($plan['can_access_prompts']) ? 'checked' : '' ?>
            ...
            <div class="flex items-center">
                <input type="checkbox" id="can_post_community" name="can_post_community" value="1"
                       <?= !empty($plan['can_post_community']) ? 'checked' : '' ?>
                       class="w-4 h-4 text-indigo-600 bg-white border-gray-300 rounded focus:ring-indigo-500">
            ...
            <div class="flex items-center">
                <input type="checkbox" id="can_access_live_qa" name="can_access_live_qa" value="1"
                       <?= !empty($plan['can_access_live_qa']) ? 'checked' : '' ?>
                       class="w-4 h-4 text-indigo-600 bg-white border-gray-300 rounded focus:ring-indigo-500">
            ...
            <div class="flex items-center">
                <input type="checkbox" id="community_read_only" name="community_read_only" value="1"
                       <?= !empty($plan['community_read_only']) ? 'checked' : '' ?>
                       class="w-4 h-4 text-indigo-600 bg-white border-gray-300 rounded focus:ring-indigo-500">
...
<!-- Hidden delete form -->
<form id="delete-form" method="POST" action="/admin/memberships/delete" class="hidden">
    <?= csrfField() ?>
    <input type="hidden" name="id" value="<?= $plan['id'] ?>">
</form>
