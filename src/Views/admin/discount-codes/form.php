...
<div class="mb-6">
    <a href="/admin/discount-codes" class="inline-flex items-center text-sm text-gray-400 hover:text-white transition">
...
<form method="POST" action="<?= $isEdit ? '/admin/discount-codes/update' : '/admin/discount-codes/store' ?>" class="space-y-8">
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-6">
        <h3 class="text-lg font-semibold text-white mb-6"><?= $isEdit ? 'Edit Discount Code' : 'New Discount Code' ?></h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Code -->
            <div>
                <label for="code" class="block text-sm font-medium text-gray-300 mb-2">Discount Code *</label>
                <input type="text" name="code" id="code" required
                    class="w-full px-4 py-2.5 bg-gray-700 border border-gray-600 text-white placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent uppercase"
            ...
            <!-- Type -->
            <div>
                <label for="type" class="block text-sm font-medium text-gray-300 mb-2">Discount Type *</label>
            ...
            <!-- Min Order Amount -->
            <div>
                <label for="min_order_dkk" class="block text-sm font-medium text-gray-300 mb-2">Minimum Order Amount (DKK)</label>
            ...
            <!-- Max Uses -->
            <div>
                <label for="max_uses" class="block text-sm font-medium text-gray-300 mb-2">Max Uses</label>
            ...
            <!-- Applies To -->
            <div>
                <label for="applies_to" class="block text-sm font-medium text-gray-300 mb-2">Applies To</label>
    ...
    <div class="flex items-center justify-end space-x-4">
        <a href="/admin/discount-codes" class="px-4 py-2 text-sm font-medium text-gray-300 bg-gray-700 hover:bg-gray-600 rounded-lg transition">
            Cancel
        </a>
