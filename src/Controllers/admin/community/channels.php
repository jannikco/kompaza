...
if (isPost()) {
    ...
    if ($action === 'create') {
        ...
        logAudit('community_channel_created', 'community_channel', $id);
        flashMessage('success', 'Channel created successfully.');
        redirect('/admin/community/channels');
    }
    ...
    if ($action === 'delete') {
        ...
        CommunityChannel::delete($id, $tenantId);

        logAudit('community_channel_deleted', 'community_channel', $id);
        flashMessage('success', 'Channel deleted successfully.');
        redirect('/admin/community/channels');
    }
